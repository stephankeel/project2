...
describe('AnalogPortService', () => {
  ...
  it('should create', inject([AnalogPortService, HumidityDeviceCacheService, TemperatureDeviceCacheService, PortsService], (service: AnalogPortService) => {
    expect(service).toBeTruthy();
  }));

  it('should unusedPorts AI_1 and AI_2', inject([AnalogPortService, HumidityDeviceCacheService, TemperatureDeviceCacheService, PortsService], (service: AnalogPortService) => {
  ...
  it('should unusedPorts AI_1 (AI_2 used by tempDevice)', inject([AnalogPortService, HumidityDeviceCacheService, TemperatureDeviceCacheService, PortsService], (service: AnalogPortService) => {
    const unusedInputPortsObservable = service.getUnusedInputPorts();
  ...
  it('should unusedPorts AI_2 (AI_1 used by humidityDevice)', inject([AnalogPortService, HumidityDeviceCacheService, TemperatureDeviceCacheService, PortsService], (service: AnalogPortService) => {
    const unusedInputPortsObservable = service.getUnusedInputPorts();
  ...
  it('should unusedPorts empty (AI_1 used by humidityDevice, AI_2 used by tempDevice)', inject([AnalogPortService, HumidityDeviceCacheService, TemperatureDeviceCacheService, PortsService], (service: AnalogPortService) => {
    const unusedInputPortsObservable = service.getUnusedInputPorts();
    getAllHumidityDevices.next([{port: Port.AI_1}])
    getAllTemperatureDevices.next([{port: Port.AI_2}])
    unusedInputPortsObservable.subscribe(ports => {
