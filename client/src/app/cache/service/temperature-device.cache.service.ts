...
@Injectable()
export class TemperatureDeviceCacheService extends GenericeCacheService<IAnalogDevice> {
  constructor(private authHttp: AuthHttp, private socketService1: ClientSocketService, private notificationService1: NotificationService) {
    super(authHttp, socketService1, notificationService1, '/api/devices/temperature', '/temperature');
  }
}
