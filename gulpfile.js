...
gulp.task('run-server', function () {
    spawn('./node_modules/gulp/bin/gulp.js', [], {stdio: 'inherit', cwd: 'server'});
});
gulp.task('watch-and-build-client', function () {
    spawn('./node_modules/gulp/bin/gulp.js', [], {stdio: 'inherit', cwd: 'client'});
});
gulp.task('watch-and-build-client-without-logs', function () {
    spawn('./node_modules/gulp/bin/gulp.js', ['watch-and-build-without-logs'], {stdio: 'inherit', cwd: 'client'});
});
